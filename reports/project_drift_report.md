...
Generated: 2026-03-26T08:57:23.020560+00:00

Reconciles 4 layers: audit doc, master plan, previous scan, and repo filesystem.

## Changes since last scan (2026-03-26T08:57:22.181795+00:00)
...
## Filesystem drift (44 items: 0 high, 1 medium, 43 low)
...
- **API route not in audit: GET /internal/intelligence/loss-analysis**: Defined in apps/api/routes/intelligence.py
- **API route not in audit: GET /internal/intelligence/score-effectiveness**: Defined in apps/api/routes/intelligence.py
- **API route not in audit: GET /internal/intelligence/cohorts**: Defined in apps/api/routes/intelligence.py
...
- **API route not in audit: GET /internal/outcomes/history/{lead_id}**: Defined in apps/api/routes/internal.py
...
- **API route not in audit: POST /internal/contact-attempts**: Defined in apps/api/routes/internal.py
- **API route not in audit: GET /internal/contact-attempts/{lead_id}**: Defined in apps/api/routes/internal.py
...
- **Python module not in audit: apps/api/routes/intelligence.py**: 361 lines, 7 functions
